...
function adminCheck(){
	...
	if(session.getAttribute("idKey").equals("master")){
	url = "login_admin.jsp";
	}
	}
	%>
...
<tr>
<td align="center" border="0" cellspacing="0" cellpadding="5">
<tr>
<td align="center" valign="middle" bgcolor="#FFFFCC">
<table border="1" cellspacing="0" cellpadding="2" aling="center" width="600">
...
<input type="button" value="로그인" onClick="adminCheck()"></td>
</tr>
</table>
</td>
</tr>
